    ...
    <section className="section bg-light" id="skills">
      <div className="container">
        ...
        <div className="row margin-t-30">
          ...
          <Skill
            name="Node"
            description="I will be using this on a team starting in the Fall of 2021 at Siemens. I also have completed a 40+ hour course learning Nodejs."
            icon="fab fa-node"
          />
          <Skill
            name="MongoDB"
            description="I've started improving my skills by utilizing MongoDB. I've also taken some udemy courses that have taught me how to use MongoDB."
